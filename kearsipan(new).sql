...
insert  into `pengadaan_barang`(`ID_PENGADAAN1`,`URAIAN_PENGADAAN1`,`VOLUME1`,`SATUAN1`,`PAGU1`,`REALISASI1`,`KETERANGAN_RPB1`) values 
(9,'Cairan Pencuci Piring',2,'BKS',41500,41500,'Kegiatan A'),
(10,'handsanitizer 5 liter',2,'LITER',150000,150000,'Kegiatan A'),
(12,'Kapur barus kamar mandi',2,'BKS',30000,30000,'Kegiatan A'),
(16,'kertas HVS A4',3,'RIM',45000,45000,'Kegiatan C');
...
insert  into `rencana_pengadaan_barang`(`ID_PENGADAAN`,`URAIAN_R_PENGADAAN`,`VOLUME`,`SATUAN`,`PAGU`,`REALISASI`,`KETERANGAN_RPB`) values 
(2,'Cairan Pencuci Piring',2,'BKS',41500,41500,'Kegiatan A'),
(3,'handsanitizer 5 liter',5,'LITER',150000,150000,'Kegiatan A'),
(4,'Kapur barus kamar mandi',1,'BKS',30000,30000,'Kegiatan A'),
(5,'kertas HVS A4',3,'RIM',50000,50000,'Kegiatan B');
